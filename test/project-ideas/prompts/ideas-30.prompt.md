# Prompt for ideas-30.json

**Save ChatGPT reply as:** test/project-ideas/ideas-30.json
...
| product_name | Smart Forest Fire Detection and Alert System |
...
- highlighttitle: A remote monitoring system that detects forest fire conditions at an early stage and sends alerts to authorities.
- prodtags: ESP32, Arduino IDE, temperature sensor, smoke sensor, flame sensor, GPS module, LoRa/GSM communication, Forest monitoring, disaster management
- existing short text: Project Name Smart Forest Fire Detection and Alert System Description A remote monitoring system that detects forest fire conditions at an early stage and sends alerts to authorities. It helps reduce damage caused by wildfires. Technologies ESP32, Arduino IDE, temperature sensor, smoke sensor, flame sensor, GPS module, LoRa/GSM communication Applications Forest monitoring, disaster management Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **Smart Forest Fire Detection and Alert System** — avoid copy-paste generic IoT fluff.
- Include prodid=74 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-30.json.
