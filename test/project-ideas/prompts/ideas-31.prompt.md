# Prompt for ideas-31.json

**Save ChatGPT reply as:** test/project-ideas/ideas-31.json
...
| product_name | Smart RFID-Based Attendance and Access Management System |
...
- highlighttitle: An automated attendance and security system that uses RFID cards for identification and access control.
- prodtags: ESP32, Arduino IDE, RFID reader, RFID tags, LCD display, servo lock, Wi-Fi, database, Schools, offices, industries
- existing short text: Project Name Smart RFID-Based Attendance and Access Management System Description An automated attendance and security system that uses RFID cards for identification and access control. Records are stored digitally for monitoring. Technologies ESP32, Arduino IDE, RFID reader, RFID tags, LCD display, servo lock, Wi-Fi, database Applications Schools, offices, industries Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **Smart RFID-Based Attendance and Access Management System** — avoid copy-paste generic IoT fluff.
- Include prodid=75 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-31.json.
