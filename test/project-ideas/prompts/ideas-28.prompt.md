# Prompt for ideas-28.json

**Save ChatGPT reply as:** test/project-ideas/ideas-28.json
...
| product_name | Automated Inventory Management System using RFID and IoT |
...
- highlighttitle: A smart inventory tracking system that automatically records product movement and stock levels using RFID technology.
- prodtags: ESP32, Arduino IDE, RFID reader, RFID tags, barcode scanner, OLED display, database, Wi-Fi, Warehouses, retail stores
- existing short text: Project Name Automated Inventory Management System using RFID and IoT Description A smart inventory tracking system that automatically records product movement and stock levels using RFID technology. It reduces manual inventory management. Technologies ESP32, Arduino IDE, RFID reader, RFID tags, barcode scanner, OLED display, database, Wi-Fi Applications Warehouses, retail stores Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **Automated Inventory Management System using RFID and IoT** — avoid copy-paste generic IoT fluff.
- Include prodid=72 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-28.json.
