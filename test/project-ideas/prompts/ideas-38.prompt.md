# Prompt for ideas-38.json

**Save ChatGPT reply as:** test/project-ideas/ideas-38.json
...
| product_name | IoT-Based Smart Fire Extinguisher Cabinet with Auto Alert |
...
- highlighttitle: A monitored cabinet that checks extinguisher presence, pressure and tamper status, sending an instant alert to facility managers if a unit is missing, low on pressure, or removed without authorization.
- prodtags: ESP32, Arduino IDE, pressure sensor, IR/weight sensor, RFID tag, buzzer, GSM/Wi-Fi, cloud dashboard, Factories, offices, public buildings, fire safety compliance
- existing short text: Project Name IoT-Based Smart Fire Extinguisher Cabinet with Auto Alert Description A monitored cabinet that checks extinguisher presence, pressure and tamper status, sending an instant alert to facility managers if a unit is missing, low on pressure, or removed without authorization. Technologies ESP32, Arduino IDE, pressure sensor, IR/weight sensor, RFID tag, buzzer, GSM/Wi-Fi, cloud dashboard Applications Factories, offices, public buildings, fire safety compliance Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **IoT-Based Smart Fire Extinguisher Cabinet with Auto Alert** — avoid copy-paste generic IoT fluff.
- Include prodid=82 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-38.json.
