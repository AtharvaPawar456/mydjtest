# Prompt for ideas-25.json

**Save ChatGPT reply as:** test/project-ideas/ideas-25.json
...
| product_name | Smart Parking Slot Detection and Reservation System |
...
- highlighttitle: An automated parking management system that detects available parking spaces and allows users to reserve slots through a mobile/web application.
- prodtags: ESP32, Arduino IDE, ultrasonic sensors, IR sensors, RFID module, LCD display, Wi-Fi, Firebase/Blynk, Shopping malls, offices, smart city parking
- existing short text: Project Name Smart Parking Slot Detection and Reservation System Description An automated parking management system that detects available parking spaces and allows users to reserve slots through a mobile/web application. It reduces searching time and improves parking management. Technologies ESP32, Arduino IDE, ultrasonic sensors, IR sensors, RFID module, LCD display, Wi-Fi, Firebase/Blynk Applications Shopping malls, offices, smart city parking Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **Smart Parking Slot Detection and Reservation System** — avoid copy-paste generic IoT fluff.
- Include prodid=69 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-25.json.
