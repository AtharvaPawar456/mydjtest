# Prompt for ideas-35.json

**Save ChatGPT reply as:** test/project-ideas/ideas-35.json
...
| product_name | Wearable Health Vitals Monitoring Band with Emergency SOS |
...
- highlighttitle: A wrist-worn band that continuously tracks heart rate, SpO2 and body temperature, and sends an emergency alert with GPS location to a caregiver when vitals cross a safe threshold or the wearer presses an SOS button.
- prodtags: ESP32, Arduino IDE, MAX30100/MAX30102 sensor, body temperature sensor, GPS module, GSM/Bluetooth, mobile app, Personal healthcare, elderly monitoring, fitness tracking
- existing short text: Project Name Wearable Health Vitals Monitoring Band with Emergency SOS Description A wrist-worn band that continuously tracks heart rate, SpO2 and body temperature, and sends an emergency alert with GPS location to a caregiver when vitals cross a safe threshold or the wearer presses an SOS button. Technologies ESP32, Arduino IDE, MAX30100/MAX30102 sensor, body temperature sensor, GPS module, GSM/Bluetooth, mobile app Applications Personal healthcare, elderly monitoring, fitness tracking Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **Wearable Health Vitals Monitoring Band with Emergency SOS** — avoid copy-paste generic IoT fluff.
- Include prodid=79 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-35.json.
