# Prompt for ideas-23.json

**Save ChatGPT reply as:** test/project-ideas/ideas-23.json
...
| product_name | Autonomous Fire Detection and Rescue Robot |
...
- highlighttitle: A robot that detects fire locations and assists in emergency situations.
- prodtags: ESP32, Arduino IDE, flame sensor, temperature sensor, gas sensor, water pump, servo motor, camera module, Industrial safety, fire emergency systems
- existing short text: Project Name Autonomous Fire Detection and Rescue Robot Description A robot that detects fire locations and assists in emergency situations. It can navigate toward fire sources and activate extinguishing mechanisms. Technologies ESP32, Arduino IDE, flame sensor, temperature sensor, gas sensor, water pump, servo motor, camera module Applications Industrial safety, fire emergency systems Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **Autonomous Fire Detection and Rescue Robot** — avoid copy-paste generic IoT fluff.
- Include prodid=67 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-23.json.
