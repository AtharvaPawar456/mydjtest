# Prompt for ideas-41.json

**Save ChatGPT reply as:** test/project-ideas/ideas-41.json
...
| product_name | IoT-Based Smart Helmet for Rider Safety and Accident Alert |
...
- highlighttitle: A two-wheeler helmet that checks for helmet-wear and alcohol before allowing ignition, and automatically sends an accident alert with GPS coordinates to emergency contacts if a crash is detected.
- prodtags: ESP32, Arduino IDE, MPU6050 accelerometer, alcohol (MQ3) sensor, IR wear-detection sensor, GPS module, GSM module, Road safety, two-wheeler rider protection
- existing short text: Project Name IoT-Based Smart Helmet for Rider Safety and Accident Alert Description A two-wheeler helmet that checks for helmet-wear and alcohol before allowing ignition, and automatically sends an accident alert with GPS coordinates to emergency contacts if a crash is detected. Technologies ESP32, Arduino IDE, MPU6050 accelerometer, alcohol (MQ3) sensor, IR wear-detection sensor, GPS module, GSM module Applications Road safety, two-wheeler rider protection Report Contents Components List (BOM: Bill of Material) Block Diagram Flow Chart Components : Name, Images, Details Circuit Diagram Problem Statement Abstract Introduction Methodology Challenges and Solutions Performance Analysis Advantages Limitation Application Future Scope Conclusion Output Images Project Deliverables Project Hardware Project Report Project Simulation
...
- Be specific to **IoT-Based Smart Helmet for Rider Safety and Accident Alert** — avoid copy-paste generic IoT fluff.
- Include prodid=85 and category_slug="hardware" and product_name exactly as given.

After you produce the JSON, I will save it as ideas-41.json.
